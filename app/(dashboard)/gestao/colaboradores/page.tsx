...
export default function GestaoColaboradoresPage() {
  ...
  function abrirEmail(email: string) { window.open(`mailto:${email}`, "_blank"); }
    ...
    <div className="space-y-6 pb-10">
      ...
      {loading ? (
        ...
        <div className="text-center py-16 text-slate-400">
          ...
          <p className="text-sm mt-2">Nenhum colaborador encontrado.</p>
        </div>
      ) : (
        <>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-1.5 flex-wrap">
                        ...
                        <span className={`text-[10px] font-semibold px-2 py-0.5 rounded-full ${catInfo.badge}`}>{catInfo.icone} {catInfo.labelSingular}</span>
                      </div>
                      {col.email && <p className="text-xs text-slate-500">{col.email}</p>}
                      ...
                      <div className="flex gap-2 mt-3">
                        {col.whatsapp ? (
                          <button onClick={() => abrirWhatsApp(col.whatsapp!, col.nome)}
                        ...
                        {col.email ? (
                          <button onClick={() => abrirEmail(col.email!)}
