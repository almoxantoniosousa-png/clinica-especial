...
export function RoleSidebar({ userRole }: RoleSidebarProps) {
  ...
  return (
    <>
      <aside className="hidden sm:flex w-64 bg-white border-r border-slate-200 min-h-screen flex-col bg-white border-r border-slate-200 min-h-screen flex-col">
        <SidebarContent />
      </aside>

      <div className="sm:hidden fixed top-0 left-0 right-0 z-40 bg-white border-b border-slate-200 px-4 py-3 flex items-center justify-between shadow-sm">
      ...
      {menuAberto && (
        <>
          ...
          <div className="sm:hidden fixed top-0 left-0 h-full w-72 z-50 bg-white shadow-xl flex flex-col">
