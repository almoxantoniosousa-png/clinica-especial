...
const SUPERVISORA: AjudaConteudo = {
  ...
  itens: [
    ...
    {
      icone: "🗓️", titulo: "Escala Acompanhantes", mockup: "escala",
      texto: "Cadastro semanal de atendimentos dos acompanhantes terapêuticos (AT) — separado da escala dos especialistas.\n\nFunciona igual à Escala Especialistas: filtros, visualização por dia/semana, marcação de presença (P/F/FJ), motivo de troca/ausência, histórico e consulta por data, e impressão pro mural.",
      reflexo: "O atendimento cadastrado aqui aparece na \"Minha Escala\" do AT responsável."
    },
    {
      icone: "📜", titulo: "Protocolos", mockup: "protocolos",
