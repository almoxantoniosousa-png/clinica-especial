...
const GESTAO: AjudaConteudo = {
  ...
  itens: [
    ...
    },
    {
      ...
      texto: "Quando uma família procura a clínica pela primeira vez (indicação, contato pelo WhatsApp etc.), esse primeiro contato é só informal — só pra pegar o telefone de contato, sem registrar nada ainda. Clique em \"+ Gerar Link\", informe nome da criança e telefone de contato, e o sistema cria um link único que você copia e manda por WhatsApp. A família preenche a entrevista completa (histórico médico, escola, comportamento, rotina, objetivos etc.) direto pelo celular, sem precisar de login — as perguntas são rápidas e objetivas (a maioria é só marcar Sim/Não ou escolher uma opção), pra não tomar muito tempo da família; você aprofunda cada ponto pessoalmente na entrevista inicial de verdade.\n\nO que a família mesma vai preencher (nome, endereço, diagnóstico, alergia etc.) não precisa ser digitado por você. Durante ou depois da entrevista inicial, preencha o bloco \"📅 Agendamento e Convênio\" dentro do registro (data/horário, CID/médico/CRM, dados do convênio) — fica sempre editável, pode completar ou atualizar quando quiser.\n\nA lista mostra o status de cada uma: 🔗 Link enviado (aguardando a família responder), ✅ Respondido (aguardando você revisar), 👶 Virou paciente ou 📁 Não seguiu adiante. Clique numa entrevista respondida pra ver tudo que a família preencheu, anotar uma observação interna, e decidir o próximo passo.\n\n👶 Ao clicar em \"Virou paciente\", o card completo da criança nasce sozinho — já preenchido com o que os pais responderam (nome, nascimento, responsável, diagnóstico, alergias, medicamentos, convênio) — e te leva direto pra ele, pra você revisar e completar o resto.\n\nSe gerar um link errado ou de teste, abra o registro e clique em \"🗑️ Excluir este registro\" lá embaixo (pede confirmação antes de apagar de vez).",
      reflexo: "Essa tela é independente do cadastro de Crianças — mantém um histórico de todas as famílias que já procuraram a clínica, mesmo as que não seguiram em frente."
    },
    {
      icone: "👶", titulo: "Crianças", mockup: "lista-cards",
