...
const GESTAO: AjudaConteudo = {
  ...
  itens: [
    ...
    },
    {
      ...
      texto: "Quando uma família liga pra clínica perguntando sobre atendimento, clique em \"+ Gerar Link\" e informe nome da criança e telefone de contato — o sistema cria um link único que você copia e manda por WhatsApp. A família preenche a entrevista completa (histórico médico, escola, comportamento, rotina, objetivos etc.) direto pelo celular, sem precisar de login.\n\nEssa tela substitui a antiga ficha de cadastro de papel do primeiro contato. O que a família mesma vai preencher (nome, endereço, diagnóstico, alergia etc.) não precisa ser digitado por você — só o que só você sabe na hora da ligação: data/horário da entrevista, CID/médico/CRM e dados do convênio. No \"+ Gerar Link\" tem um \"+ Já tenho agendamento, convênio ou laudo dessa ligação\" pra isso (tudo opcional). E dentro de cada entrevista, o bloco \"📞 Dados da ligação\" fica sempre editável — pode completar depois, inclusive num 2º contato.\n\nA lista mostra o status de cada uma: 🔗 Link enviado (aguardando a família responder), ✅ Respondido (aguardando você revisar), 👶 Virou paciente ou 📁 Não seguiu adiante. Clique numa entrevista respondida pra ver tudo que a família preencheu, anotar uma observação interna, e decidir o próximo passo.\n\nFazer a entrevista não cadastra a criança automaticamente — só quando você marcar \"Virou paciente\" é que faz sentido cadastrá-la em Crianças, usando os dados da entrevista como referência.\n\nSe gerar um link errado ou de teste, abra o registro e clique em \"🗑️ Excluir este registro\" lá embaixo (pede confirmação antes de apagar de vez).",
